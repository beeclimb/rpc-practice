...
/**
 * Dynamic proxy class.
 * When a dynamic proxy object calls a method, it actually calls following invoke method.
 * It is precisely because of the dynamic proxy that the remote method called by client
 * is like calling the local method (the intermediate process is shielded)
 *
 * @author jun.ma
 * @date 2022/5/31 22:13:00
 */
@Slf4j
public class RpcClientProxy implements InvocationHandler {
     ...
     * The proxy object is the object you get thought the getProxy method.
     */
    @SneakyThrows
    @Override
